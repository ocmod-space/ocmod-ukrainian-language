...
$_['button_upload'] = 'Вивантажити файл';
...
$_['error_upload_2'] = 'Попередження: Вивантажений файл перевищує MAX_FILE_SIZE значення, яка була вказана в налаштуваннях!';
$_['error_upload_3'] = 'Попередження: Файли були вивантажені лише частково!';
$_['error_upload_4'] = 'Попередження: Немає файлів для вивантаження!';
$_['error_upload_6'] = 'Попередження: Тимчасова папка!';
$_['error_upload_7'] = 'Попередження: Помилка запису!';
$_['error_upload_8'] = 'Попередження: Заборонено вивантажувати файл з даними розширенням!';
