...
$_['text_login'] = 'Для того щоб написати відгук потрібно <a href="%s">авторизуватися</a> або <a href="%s">створити обліковий запис</a>.';
...
$_['text_success'] = 'Дякуємо за ваш відгук. Він вступив адміністратору для перевірки на спам і незабаром буде опублікований.';
...
$_['entry_good'] = 'Добре';
$_['entry_bad'] = 'Погано';
$_['entry_captcha'] = 'Введіть код, зазначений на зображенні:';
...
$_['error_rating'] = 'Будь ласка, вкажіть рейтинг!';
$_['error_captcha'] = 'Код, зазначений на зображенні, введено невірно!';
