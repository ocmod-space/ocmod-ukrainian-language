...
$_['entry_stock_status'] = 'Статус відсутності';
$_['entry_price'] = 'Ціна';
...
// Help
$_['help_keyword'] = 'має бути унікальним на всю систему і без пробілів.';
...
$_['help_stock_status'] = 'Статус показується, коли товару немає на складі, тобто к-ть дорівнює нулю';
