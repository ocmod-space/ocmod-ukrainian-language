...
$_['text_edit'] = '<a href="customer_id=%d>%s</a> - оновлено інформація облікового запису.';
$_['text_forgotten'] = '<a href="customer_id=%d>%s</a> - запропоновано новий пароль.';
$_['text_reset'] = '<a href="customer_id=%d>%s</a> - відновлено пароль.';
$_['text_login'] = '<a href="customer_id=%d>%s</a> - виконано вхід.';
